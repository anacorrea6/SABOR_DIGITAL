...
class produtoRepository{
    async listarTodosOsProduto(){
        const [listaTodosProduto] = await pool.query('SELECT * FROM produto')
    ...
    async cadastrarNovoProduto (dados){
        ...
        const [id] = await pool.query('INSERT INTO produto (nome,descricao,preco,categoria, disponivel) VALUES (?,?,?,?,?)'[nome,descricao,preco,categoria, dispinivel])
